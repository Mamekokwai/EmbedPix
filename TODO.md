...
证据：`b820864` 覆盖 spool 单帧/总量/帧数预算、200 帧边界、成功读取、失败/取消清理和孤儿目录清理；`4d06ca5` 提供 MP4/WebM 确定性 fixture 及抽帧 smoke 说明；`a072ede` 的 E3 报告覆盖长视频代理和 200 帧样本。扫描/清理耗时目前仅写入运行时 stderr，尚无持久化报告，故对应子项和本条总验收暂不勾选；真实浏览器长视频 seek/decode 仍需 E1 窗口 E2E。
