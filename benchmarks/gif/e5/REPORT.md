...
| --- | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: |
| high-quality | 640×360 | 24 | 256 | 120 | 1 | Floyd-Steinberg | 10,297,623 B | 22,020 ms | 3 |
| balanced | 480×270 | 20 | 128 | 80 | 10 | none | 943,695 B | 618 ms | 4 |
| small-size | 320×180 | 12 | 64 | 48 | 20 | none | 259,005 B | 109 ms | 5 |

三档均使用当前后端的逐帧 NeuQuant 自适应调色板；本次不引入新的调色板依赖。现有 C5 自动压缩负责受限候选搜索，本 E5 预设基准固定参数，不把搜索耗时混入预设对比。阈值见 `thresholds.json`，包含耗时、体积、峰值内存和 MAE 上限。
